...
const [currentitem,setcurrentitem]=useState(null)
  ...
  // it is for  Handle image preview & upload
...
//  it for handling the submit button
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await axios.post(`${serverurl}/api/item/edititem/${itemId}`,
        formData,
  ...
  useEffect(()=>{
    ...
    const handlegetitem =async ()=>{
           const result = await axios.get(`${serverurl}/api/item/getitem/${itemId}`,
...
// it is for showing previous data to input
    useEffect(() => {
    if (currentitem) {
